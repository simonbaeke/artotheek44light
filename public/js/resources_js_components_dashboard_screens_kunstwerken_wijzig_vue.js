(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_components_dashboard_screens_kunstwerken_wijzig_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_2__.mapGetters)({
    ...
    artworkLoading: 'kunstwerken/loading',
    artworkSaving: 'kunstwerken/saving'
  })), {}, {
    kunstwerk: function kunstwerk() {
      return this.$store.getters['kunstwerken/kunstwerk'](this.$route.params.id);
    }
  }),
  watch: {
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_2__.mapActions)({
    ...
    getKunstwerk: 'kunstwerken/fetchOne',
    update: 'kunstwerken/update'
  })), {}, {
    ...
    save: function save() {
      ...
      formData.append('id', this.artwork.id);
    ...
    getCode: function getCode() {
      ...
      axios.post('/api/artworks/code', {
        ...
        _this2.precode = response.data.precode;
      });
    }
  }),
  components: {
  ...
  mounted: function mounted() {
    ...
    this.setTitle('Wijzig Kunstwerk');
    this.getArtists();
    this.getTypes(); //check of kunstwerk in lijst staat

    new Promise(function (resolve, reject) {
      if (_this3.kunstwerk == null) {
        _this3.getKunstwerk(_this3.$route.params.id).then(function () {
          return resolve();
        });
      } else {
        resolve();
      ...
      console.log('artworkresolved');
      _this3.type_id = _this3.kunstwerk.type.id;
      _this3.artist_id = _this3.kunstwerk.artist.id;
      _this3.artwork = new _Form__WEBPACK_IMPORTED_MODULE_1__.Form({
        id: _this3.kunstwerk.id,
        name: _this3.kunstwerk.name,
        type_id: _this3.kunstwerk.type.id,
        artist_id: _this3.kunstwerk.artist.id,
        thumbnailurl: "",
        price: _this3.kunstwerk.price,
        length: _this3.kunstwerk.length,
        width: _this3.kunstwerk.width,
        height: _this3.kunstwerk.height,
        code: _this3.kunstwerk.code,
        forsale: _this3.kunstwerk.forsale
      });
    });
  },
  beforeDestroy: function beforeDestroy() {
...
/***/ "./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue":
/*!**************************************************************************!*\
  !*** ./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _wijzig_vue_vue_type_template_id_67624b68_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./wijzig.vue?vue&type=template&id=67624b68&scoped=true& */ "./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=template&id=67624b68&scoped=true&");
/* harmony import */ var _wijzig_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./wijzig.vue?vue&type=script&lang=js& */ "./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  _wijzig_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__.default,
  _wijzig_vue_vue_type_template_id_67624b68_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _wijzig_vue_vue_type_template_id_67624b68_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "67624b68",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/dashboard/screens/kunstwerken/wijzig.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************!*\
  !*** ./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_wijzig_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./wijzig.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_wijzig_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__.default); 
...
/***/ "./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=template&id=67624b68&scoped=true&":
/*!*********************************************************************************************************************!*\
  !*** ./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=template&id=67624b68&scoped=true& ***!
  \*********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_wijzig_vue_vue_type_template_id_67624b68_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_wijzig_vue_vue_type_template_id_67624b68_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_wijzig_vue_vue_type_template_id_67624b68_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./wijzig.vue?vue&type=template&id=67624b68&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=template&id=67624b68&scoped=true&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=template&id=67624b68&scoped=true&":
/*!************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/dashboard/screens/kunstwerken/wijzig.vue?vue&type=template&id=67624b68&scoped=true& ***!
  \************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
          ...
          _c(
            ...
            [
              _c(
                "v-btn",
                {
                  attrs: { outlined: "", loading: _vm.artworkSaving },
                  on: { click: _vm.save }
                },
                [_vm._v("Opslaan")]
              ),
              _vm._v(" "),
              _c("v-btn", { attrs: { outlined: "" } }, [_vm._v("Annuleer")])
            ],
            1
          )
        ],
